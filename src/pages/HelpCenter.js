    ...
    <Layout className="help-center-container">
      <Content style={{ padding: '24px', maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div id="buying-guide">
          ...
          <Divider />
          <Collapse defaultActiveKey={['1']} expandIconPosition="end" items={buyingGuideItems} />
        </div>
        ...
        <div id="selling-guide">
          ...
          <Divider />
          <Collapse defaultActiveKey={['1']} expandIconPosition="end" items={sellingGuideItems} />
        </div>
        ...
        <div id="safety-guide">
          ...
          <Divider />
          <Collapse defaultActiveKey={['1']} expandIconPosition="end" items={safetyGuideItems} />
        </div>
